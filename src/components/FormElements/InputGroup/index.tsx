...
import { Eye, EyeOff } from "lucide-react"; // You can replace with your own icons
  ...
  return (
    <div className={className}>
      ...
      >
        ...
        {/* Left icon */}
        {props.iconPosition !== "right"  && !isPassword && icon}

        {/* Password toggle (only if type is password) */}
        {isPassword && (
          <button
            type="button"
            onClick={() => setShowPassword((prev) => !prev)}
            className="absolute right-2 top-1/2 -translate-y-1/2 text-dark-1 dark:text-white"
          >
